--  queries previous_12_months_final for the top 50 start locations by customer type
  -- used to visualize geographical 'hot spots' for each customer type
